...
const SECTIONS: LegalSection[] = [
  { id: "s1", label: "Aceptación de estos términos" },
  { id: "s2", label: "Qué encontrarás en este Sitio" },
  { id: "s3", label: "Uso aceptable del Sitio" },
  { id: "s4", label: "Propiedad intelectual" },
  { id: "s5", label: "Enlaces y canales de terceros" },
  { id: "s6", label: "Limitación de responsabilidad" },
  { id: "s7", label: "Modificaciones a estos términos" },
  { id: "s8", label: "Disposiciones generales" },
